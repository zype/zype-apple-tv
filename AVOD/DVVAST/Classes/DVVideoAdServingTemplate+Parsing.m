        ...
        if (creatives && creatives.count) {
            ...
            if (creative && creative.count) {
                ...
                if (linears && linears.count) {
                    ...
                    BOOL isSkippable = [videoElement attributeForName:@"skipoffset"];
                    if (isSkippable)
                    {
                        videoAd.isSkippable = YES;
                        NSString *skipOffsetString = [videoElement attributeForName:@"skipoffset"];
                        NSString *timeString = [NSString stringWithFormat:@"%@", skipOffsetString];
                        ...
                        NSString *time = [target objectAtIndex:0];
                        ...
                        videoAd.skippableDuration = seconds;
                    }
                }
            }
        }
