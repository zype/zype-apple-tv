...
extension PlayerVC: AnalyticsHelperProtocol {
    ...
    func getSegmentAnalyticsFromResponse(_ playerObject: VideoObjectModel?) -> [String: Any] {
        ...
        customDimensions[SegmentAnalyticsAttributes.videoAccountId.rawValue] = "account_id"
        customDimensions[SegmentAnalyticsAttributes.videoAccountName.rawValue] = "account_name"
